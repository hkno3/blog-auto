...
FALLBACK_KEYWORDS = [
    ...
    "소상공인 대출 조건", "창업 보조금 신청", "재테크 방법",
    "부동산 청약 방법", "전세 사기 예방",
]

# 허용 주제 키워드 (사이트 3개의 주제와 관련된 것만 추천)
_ALLOWED_TOPICS = [
    # bodyandwell - 건강/의료/음식
    "건강", "음식", "의료", "질병", "영양", "다이어트", "운동", "피부",
    "약", "병원", "치료", "증상", "비타민", "면역", "수면", "식단",
    "탈모", "혈압", "당뇨", "암", "관절", "소화", "심장", "두통",
    "비만", "체중", "칼로리", "단백질", "유산균", "백신", "폐경",
    "갱년기", "임신", "육아", "아기", "노화", "피로", "스트레스",
    # bizachieve - 세무/금융/사업/생활
    "세무", "재무", "주식", "보조금", "창업", "대출", "금융", "사업",
    "취업", "소상공인", "학업", "여행", "회생", "파산", "정부지원",
    "보험", "문화", "카드", "청소", "폐기물", "이사", "영업",
    "교통사고", "재판", "실업", "세금", "절세", "환급", "지원금",
    "연금", "퇴직", "직장", "투자", "펀드", "적금", "청약", "재테크",
    "부업", "월급", "이직", "자격증", "공부", "수능",
    # cointrail - 부동산
    "부동산", "아파트", "전세", "월세", "임대", "매매",
...
def _is_topic_relevant(kw: str) -> bool:
    """허용 주제와 관련 있는 키워드인지 확인"""
    return any(topic in kw for topic in _ALLOWED_TOPICS)
